...
Generated from: common.xml,ardupilotmega.xml
...
class MAVLink_roll_pitch_yaw_thrust_setpoint_message(MAVLink_message):
	...
	def pack(self, mav):
		return MAVLink_message.pack(self, mav, struct.pack('>Iffff', self.time_ms, self.roll, self.pitch, self.yaw, self.thrust))
...
class MAVLink_roll_pitch_yaw_speed_thrust_setpoint_message(MAVLink_message):
	...
	def pack(self, mav):
		return MAVLink_message.pack(self, mav, struct.pack('>Iffff', self.time_ms, self.roll_speed, self.pitch_speed, self.yaw_speed, self.thrust))
...
mavlink_map = {
	...
	MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST : ( '>BBffff', MAVLink_set_roll_pitch_yaw_thrust_message ),
	MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_SPEED_THRUST : ( '>BBffff', MAVLink_set_roll_pitch_yaw_speed_thrust_message ),
	MAVLINK_MSG_ID_ROLL_PITCH_YAW_THRUST_SETPOINT : ( '>Iffff', MAVLink_roll_pitch_yaw_thrust_setpoint_message ),
	MAVLINK_MSG_ID_ROLL_PITCH_YAW_SPEED_THRUST_SETPOINT : ( '>Iffff', MAVLink_roll_pitch_yaw_speed_thrust_setpoint_message ),
	...
	MAVLINK_MSG_ID_HIL_STATE : ( '>Qffffffiiihhhhhh', MAVLink_hil_state_message ),
	MAVLINK_MSG_ID_HIL_CONTROLS : ( '>QffffBB', MAVLink_hil_controls_message ),

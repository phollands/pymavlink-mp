...
MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW = 55
MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_SPEED = 56
...
class MAVLink_set_roll_pitch_yaw_message(MAVLink_message):
	'''
	Set roll, pitch and yaw.
	'''
	def __init__(self, target_system, target_component, roll, pitch, yaw):
		MAVLink_message.__init__(self, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW, 'SET_ROLL_PITCH_YAW')
		self._fieldnames = ['target_system', 'target_component', 'roll', 'pitch', 'yaw']
		self.target_system = target_system
		self.target_component = target_component
		self.roll = roll
		self.pitch = pitch
	...
	def pack(self, mav):
		return MAVLink_message.pack(self, mav, struct.pack('>BBfff', self.target_system, self.target_component, self.roll, self.pitch, self.yaw))

class MAVLink_set_roll_pitch_yaw_speed_message(MAVLink_message):
	'''
	Set roll, pitch and yaw.
	'''
	def __init__(self, target_system, target_component, roll_speed, pitch_speed, yaw_speed):
		MAVLink_message.__init__(self, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_SPEED, 'SET_ROLL_PITCH_YAW_SPEED')
		self._fieldnames = ['target_system', 'target_component', 'roll_speed', 'pitch_speed', 'yaw_speed']
		self.target_system = target_system
		self.target_component = target_component
	...
	def pack(self, mav):
		return MAVLink_message.pack(self, mav, struct.pack('>BBfff', self.target_system, self.target_component, self.roll_speed, self.pitch_speed, self.yaw_speed))
...
mavlink_map = {
	...
	MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW : ( '>BBfff', MAVLink_set_roll_pitch_yaw_message ),
	MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_SPEED : ( '>BBfff', MAVLink_set_roll_pitch_yaw_speed_message ),
...
class MAVLink(object):
	...
	def set_roll_pitch_yaw_encode(self, target_system, target_component, roll, pitch, yaw):
		'''
		Set roll, pitch and yaw.
		...
		'''
		msg = MAVLink_set_roll_pitch_yaw_message(target_system, target_component, roll, pitch, yaw)
		msg.pack(self)
                return msg

	def set_roll_pitch_yaw_send(self, target_system, target_component, roll, pitch, yaw):
		'''
		Set roll, pitch and yaw.
		...
		'''
		return self.send(self.set_roll_pitch_yaw_encode(target_system, target_component, roll, pitch, yaw))

	def set_roll_pitch_yaw_speed_encode(self, target_system, target_component, roll_speed, pitch_speed, yaw_speed):
		'''
		Set roll, pitch and yaw.
		...
		'''
		msg = MAVLink_set_roll_pitch_yaw_speed_message(target_system, target_component, roll_speed, pitch_speed, yaw_speed)
		msg.pack(self)
                return msg

	def set_roll_pitch_yaw_speed_send(self, target_system, target_component, roll_speed, pitch_speed, yaw_speed):
		'''
		Set roll, pitch and yaw.
		...
		'''
		return self.send(self.set_roll_pitch_yaw_speed_encode(target_system, target_component, roll_speed, pitch_speed, yaw_speed))

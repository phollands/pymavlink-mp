						       ...
						       uint8_t type, uint8_t autopilot, uint8_t system_mode, uint8_t flight_mode, uint8_t system_status, uint8_t safety_status, uint8_t link_status)
{
	...
	put_uint8_t_by_index(system_mode, 2,  MAVLINK_PAYLOAD(msg)); // System mode, see MAV_MODE ENUM in mavlink/include/mavlink_types.h
	put_uint8_t_by_index(flight_mode, 3,  MAVLINK_PAYLOAD(msg)); // Navigation mode, see MAV_FLIGHT_MODE ENUM
	put_uint8_t_by_index(system_status, 4,  MAVLINK_PAYLOAD(msg)); // System status flag, see MAV_STATUS ENUM
	...
	put_uint8_t_by_index(3, 7,  MAVLINK_PAYLOAD(msg)); // MAVLink version

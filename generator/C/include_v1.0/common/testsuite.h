...
static void mavlink_test_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_heartbeat_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.system_mode = packet_in.system_mode;
...
static void mavlink_test_sys_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_sys_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.errors_uart = packet_in.errors_uart;
        	packet1.errors_i2c = packet_in.errors_i2c;
        	packet1.errors_spi = packet_in.errors_spi;
        	packet1.errors_can = packet_in.errors_can;
...
static void mavlink_test_set_flight_mode(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_flight_mode_t packet_in = {
		5,
	72,
	};
	mavlink_set_flight_mode_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target = packet_in.target;
        	packet1.flight_mode = packet_in.flight_mode;
	...
	mavlink_msg_set_flight_mode_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_set_safety_mode(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_safety_mode_t packet_in = {
		5,
	72,
	};
	mavlink_set_safety_mode_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target = packet_in.target;
        	packet1.safety_mode = packet_in.safety_mode;
	...
	mavlink_msg_set_safety_mode_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_set_flight_mode(system_id, component_id, last_msg);
	mavlink_test_set_safety_mode(system_id, component_id, last_msg);

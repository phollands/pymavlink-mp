...
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT { \
	...
	{  { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_global_position_int_t, lat) }, \
         ...
         { "hdg", NULL, MAVLINK_TYPE_UINT16_T, 0, 18, offsetof(mavlink_global_position_int_t, hdg) }, \
         } \
}
...
#else
	memcpy(global_position_int, _MAV_PAYLOAD(msg), 20);
#endif
}

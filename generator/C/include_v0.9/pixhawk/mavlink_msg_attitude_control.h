						       ...
						       uint8_t target, float roll, float pitch, float yaw, float thrust, uint8_t roll_manual, uint8_t pitch_manual, uint8_t yaw_manual, uint8_t thrust_manual)
{
	...
	put_uint8_t_by_index(msg, 0, target); // The system to be controlled
	put_float_by_index(msg, 1, roll); // roll
	put_float_by_index(msg, 5, pitch); // pitch
	put_float_by_index(msg, 9, yaw); // yaw
	put_float_by_index(msg, 13, thrust); // thrust
	...
	return mavlink_finalize_message(msg, system_id, component_id, 21, 84);
}
						           ...
						           uint8_t target,float roll,float pitch,float yaw,float thrust,uint8_t roll_manual,uint8_t pitch_manual,uint8_t yaw_manual,uint8_t thrust_manual)
{
	...
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, 21, 84);
}
						           ...
						           uint8_t target,float roll,float pitch,float yaw,float thrust,uint8_t roll_manual,uint8_t pitch_manual,uint8_t yaw_manual,uint8_t thrust_manual)
{
	...
	mavlink_finalize_message_chan_send(msg, chan, 21, 84);
}

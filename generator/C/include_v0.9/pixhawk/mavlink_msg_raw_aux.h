						       ...
						       uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t vbat, int16_t temp, int32_t baro)
{
	...
	put_uint16_t_by_index(adc1, 0,  msg->payload); // ADC1 (J405 ADC3, LPC2148 AD0.6)
	put_uint16_t_by_index(adc2, 2,  msg->payload); // ADC2 (J405 ADC5, LPC2148 AD0.2)
	put_uint16_t_by_index(adc3, 4,  msg->payload); // ADC3 (J405 ADC6, LPC2148 AD0.1)
	put_uint16_t_by_index(adc4, 6,  msg->payload); // ADC4 (J405 ADC7, LPC2148 AD1.3)
	put_uint16_t_by_index(vbat, 8,  msg->payload); // Battery voltage
	put_int16_t_by_index(temp, 10,  msg->payload); // Temperature (degrees celcius)
	put_int32_t_by_index(baro, 12,  msg->payload); // Barometric pressure (hecto Pascal)

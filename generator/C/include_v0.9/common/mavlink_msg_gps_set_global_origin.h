						       ...
						       uint8_t target_system, uint8_t target_component, int32_t latitude, int32_t longitude, int32_t altitude)
{
	...
	put_int32_t_by_index(latitude, 2,  msg->payload); // global position * 1E7
	put_int32_t_by_index(longitude, 6,  msg->payload); // global position * 1E7
	put_int32_t_by_index(altitude, 10,  msg->payload); // global position * 1000
